...
public class ShowRestaurantListActivity extends ListActivity {
	...
	protected void onCreate(Bundle aSavedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(PreferencesActivity.WizardState, Context.MODE_PRIVATE);
        if(!sharedPreferences.getBoolean(PreferencesActivity.CuisineState, false) &&
                !sharedPreferences.getBoolean(PreferencesActivity.NeighborhoodState, false) &&
                !sharedPreferences.getBoolean(PreferencesActivity.DiningTimeState, false)){
            final Intent showWizardIntent = new Intent(this, PreferencesActivity.class);
            startActivity(showWizardIntent);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        case R.id.menu_preferences: {
        	...
        	final Intent preferencesActivity = new Intent(this,PreferencesActivity.class);
        	preferencesActivity.putExtra("from_restaurants_list", true);
